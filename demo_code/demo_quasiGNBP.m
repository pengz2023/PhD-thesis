%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% Demo for quasiGNBP (quasiGNBP algorithm when the diagonal elements are unknown) %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
b_xi_sq = 0.5;
EM_maxiter=30000;
[samples_a_lambda_sq, samples_b_xi_sq, a_MML, b_MML, Diag] = quasiGNBP_hyperpara_MML_withoutK(xx, a_lambda_sq,b_xi_sq,EM_maxiter);
toc;
fprintf("*******************\n");
...
% 4. Run the quasiGNBP based on MMQL estimates of hyperprameters
fprintf("Run quasiGNBP algorithm based on the MMQL estimates of hyperprameters\n");
tic;  
a_lambda_sq = a_MML; 
b_xi_sq = b_MML; 
burnin=500;
...
FileName_3 = [path_0,'quasiGNBP_adjacenyMatrix.csv'];
